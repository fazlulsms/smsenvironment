    ...
    <div class="form-section">
        ...
        <div class="fs-body">
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label">Default Conversion Rate <span class="text-secondary fw-normal">(1 foreign unit = BDT)</span></label><input class="form-control" type="number" step="0.0001" min="0" name="default_conversion_rate" value="{{ old('default_conversion_rate', $settings->default_conversion_rate) }}" placeholder="e.g. 118"></div>
